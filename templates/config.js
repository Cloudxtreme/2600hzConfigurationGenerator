    ...
    winkstart.config =  {
        ...
        onboard_roles: {
            'default': {
                apps: {
                    voip: {
                        label: 'Hosted PBX',
                        icon: 'phone',
                        api_url: 'https://{{ fqdn }}:8443/v1' //'https://api.zswitch.net:8443/v1'
                    },
                    pbxs: {
                        label: 'PBX Connector',
                        icon: 'device',
                ...
                default_api_url: 'https://{{ fqdn }}:8443/v1' //'https://api.zswitch.net:8443/v1'
            },
            'reseller': {
                apps: {
                    voip: {
            ...
            'small_office': {
                ...
                available_apps: ['voip', 'cluster', 'userportal', 'accounts', 'developer', 'numbers', 'pbxs'],
                default_api_url: 'https://{{ fqdn }}:8443/v1'
            },
            'single_phone': {
                apps: {
                    voip: {
